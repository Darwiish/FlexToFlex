              ...
              <FormGroup>
                ...
                >
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownItem onClick={this.select}>Kredit</DropdownItem>
                    <DropdownItem onClick={this.select}>Kontant</DropdownItem>
                  </DropdownMenu>
                </Dropdown>
                ...
                >
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownItem divider />
                    {accounts.map(
                      ({ _id, accountHolder, accountType, date }) => (
                        <DropdownItem onClick={this.chooseAccount}>
                          {accountHolder}
                        </DropdownItem>
                      )
                    )}
                ...
                <InputGroup>
                  <InputGroupAddon addonType="prepend">Dk</InputGroupAddon>
                  <Input
                    type="currency"
                    name="amount"
                    id="amount"
